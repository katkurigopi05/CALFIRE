...
|---|---|---|---|
| TrendSeason **(best)** | 17.8 | 18.6 | 302.2% |
| AR | 15.0 | 19.2 | 123.7% |
...
Best backtest fit: **TrendSeason** — beats the best naive baseline (RMSE 22.4).
...
| Model | Backtest MAE | Backtest RMSE | Backtest MAPE |
|---|---|---|---|
| TrendSeason **(best)** | 237730.5 | 291793.5 | 67534.7% |
| Naive | 330205.2 | 332587.3 | 145785.1% |
...
Best backtest fit: **TrendSeason** — beats the best naive baseline (RMSE 332587.3).
